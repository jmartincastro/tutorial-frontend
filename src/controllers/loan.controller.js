...
export const getLoans = async (req, res) => {
    try {
        ...
        const loans = await LoanService.getLoans(gameToFind, clientToFind, date);
...
export const getLoansPageable = async (req, res) => {
    ...
    try {
        const response = await LoanService.getLoansPageable(gameToFind, clientToFind, date, page, limit, sort);
        res.status(200).json({
